...
gcc x/*.o lib.o entry.o -Wl,-L../userspace/dietlibc-0.33/bin-x86_64,-lm,-r    -nostdlib -nostdinc -static -nostartfiles -nodefaultlibs -Wall -Wextra -m64 -Werror -std=c11 -fno-builtin -ggdb
